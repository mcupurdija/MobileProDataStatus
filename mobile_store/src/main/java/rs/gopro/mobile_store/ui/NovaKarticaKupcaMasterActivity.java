...
public class NovaKarticaKupcaMasterActivity extends FragmentActivity implements NovaKKFragment2Listener, NovaKKFragment3Listener, NovaKKFragment4ContactListener, ContactSelectDialogListener, NovaKKFragment4ShippingAddressListener, AddressSelectDialogListener, NovaKKFragment4SaleOrderUpdated {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		customerNo = getIntent().getExtras().getString("customerNo");
		potentialCustomerNo = getIntent().getExtras().getString("potentialCustomerNo");
		branchCode = getIntent().getExtras().getString("branchCode");
		businessUnitNo = getIntent().getExtras().getString("businessUnitNo");
		salesType = getIntent().getExtras().getInt("salesType");
		salesPersonNo = getIntent().getExtras().getString("salesPersonNo");
		...
		ivHome.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				// TODO PO POTREBI SKLONITI KASNIJE
		...
		if (Intent.ACTION_INSERT.equals(mAction)) {
			...
			cv.put(SaleOrders.CUSTOMER_BUSINESS_UNIT_CODE, (businessUnitNo != null) ? businessUnitNo : "");
	...
	public class MyPagerAdapter extends FragmentPagerAdapter {
		...
		private final String[] TITLES = { "Detalji kupca", "Artikli", "Korpa", "Zaglavlje" };
		...
		public Fragment getItem(int position) {
			switch (position) {
				case 0:
					return NovaKKFragment1.newInstance(customerId, customerNo, salesPersonNo);
				case 1:
