...
public class SimpleSelectionedListAdapter extends BaseAdapter {
	...
	public SimpleSelectionedListAdapter(Context context, int sectionResourceId, ListAdapter baseAdapter) {
