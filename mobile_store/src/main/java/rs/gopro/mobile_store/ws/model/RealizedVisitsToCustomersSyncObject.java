...
public abstract class RealizedVisitsToCustomersSyncObject extends SyncObject {
	...
	public RealizedVisitsToCustomersSyncObject(Parcel parcel) {
		super(parcel);
	...
	public RealizedVisitsToCustomersSyncObject(String cSVString, String salespersonCode, Date visitDateFrom, Date visitDateTo, String customerNoa46) {
		super();
