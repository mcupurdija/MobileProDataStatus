...
public interface Tables {
	...
	String SALE_ORDERS_EXPORT = "sale_orders left outer join customers on sale_orders.customer_id = customers._id left outer join sales_persons on sale_orders.sales_person_id = sales_persons._id";
