...
public class MobileStoreDatabase extends SQLiteOpenHelper {
	...
	private static final String[] CREATE_FILES = {"create_mobile_store.sql", "create_mobile_store2.sql", "create_mobile_store3.sql", "create_mobile_store4.sql", "create_mobile_store5.sql", "create_mobile_store6.sql", "create_mobile_store7.sql"};
