...
BEGIN 
	...
	where _id = new._id; 
END;
INSERT INTO `visits` VALUES ('1','1','2013-12-18 00:00:00','1','0',null,null,'1','2012-12-18 00:00:00','2012-12-18 00:00:00',null,'dada',null,1,1, '2012-12-18 01:11:12','vlada','2012-12-18 01:11:12','vlada');
INSERT INTO `visits` VALUES ('2','1','2013-02-18 00:00:00','2','0',null,null,'1000','2012-12-18 00:00:00','2012-12-18 00:00:00',null,'dada',null,1,1,'2012-12-18 01:11:12','vlada','2012-12-18 01:11:12','vlada');
INSERT INTO `visits` VALUES ('3','1','2013-01-18 00:00:00','3','0',null,null,'1','2012-12-18 00:00:00','2012-12-18 00:00:00',null,'dada',null,1,1,'2012-12-18 01:11:12','vlada','2012-12-18 01:11:12','vlada');
INSERT INTO `visits` VALUES ('4','1','2012-12-19 00:00:00','4','0',null,null,'1000','2012-12-18 00:00:00','2012-12-18 00:00:00',null,'dada',null,1,1, '2012-12-18 01:11:12','vlada','2012-12-18 01:11:12','vlada');
INSERT INTO `visits` VALUES ('5','1','2012-12-17 00:00:00','5','0',null,null,'1','2012-12-18 00:00:00','2012-12-18 00:00:00',null,'dada',null,1,1, '2012-12-18 01:11:12','vlada','2012-12-18 01:11:12','vlada');
INSERT INTO `visits` VALUES ('6','1','2012-12-11 00:00:00','6','0',null,null,'1000','2012-12-18 00:00:00','2012-12-18 00:00:00',null,'dada',null,1,1, '2012-12-18 01:11:12','vlada','2012-12-18 01:11:12','vlada');

CREATE TABLE `sale_orders` (
	`_id` INTEGER PRIMARY KEY  AUTOINCREMENT  NOT NULL,
	`sales_order_device_no` TEXT,
	`sales_order_no` TEXT,
...
(1, 'POR12-00001','POR12-00001', 0,2, '2012-06-12 20:20:20', '300', 'SA1', 1, 'ext doc', 'quote no', 0,0,0,0,'used limitation', 2,2,2, '2012-12-12 20:20:20', null, 1, 3, null,2,'contact name','06457575',0, 'startus phone', 2000, 1000, 5, 200, 0,0, 'note1', 'note2', 'note3', '2012-12-12 20:20:20','sys', '2012-12-12 20:20:20', 'sys');
INSERT INTO `sale_orders` (	`_id`, `sales_order_device_no`,	`sales_order_no` ,	`document_type` ,	`customer_id` ,	`order_date` ,	`location_code` ,	`shortcut_dimension_1_code` ,	`currency_code` ,	`external_document_no` ,	`quote_no` ,	`backorder_shipment_status` ,	`order_status_for_shipment` ,	`fin_control_status` ,`order_condition_status` ,	`used_credit_limit_by_employee` ,	`order_value_status` ,	`quote_realized_status` ,	`special_quote` ,	`quote_valid_date_to` ,	`cust_uses_transit_cust` ,	`sales_person_id` ,	`sell_to_address_id`, `shipp_to_address_id`, `contact_id`, `contact_name`, `contact_phone` , `payment_option` ,	`check_status_phone` ,	`total` ,	`total_discount` ,	`total_pdv` ,	`total_items` ,	`hide_rebate` ,	`further_sale`,	`note1` ,	`note2` ,	`note3` ,	`created_date` ,	`created_by` ,	`updated_date` ,	`updated_by`) VALUES
(2, 'POR12-00002','POR12-00002', 0,2, '2012-12-12 10:20:20', '300', 'SA1', 1, 'ext doc', 'quote no', 0,0,0,0,'used limitation', 2,2,2, '2012-12-12 20:20:20', null, 1, 3, null,2,'contact name','06457575',0, 'startus phone', 2500, 1000, 5, 200, 0,0, 'note1', 'note2', 'note3', '2012-12-12 20:20:20','sys', '2012-12-12 20:20:20', 'sys');
INSERT INTO `sale_orders` (	`_id`, `sales_order_device_no`,	`sales_order_no` ,	`document_type` ,	`customer_id` ,	`order_date` ,	`location_code` ,	`shortcut_dimension_1_code` ,	`currency_code` ,	`external_document_no` ,	`quote_no` ,	`backorder_shipment_status` ,	`order_status_for_shipment` ,	`fin_control_status` ,`order_condition_status` ,	`used_credit_limit_by_employee` ,	`order_value_status` ,	`quote_realized_status` ,	`special_quote` ,	`quote_valid_date_to` ,	`cust_uses_transit_cust` ,	`sales_person_id` ,	`sell_to_address_id`, `shipp_to_address_id`, `contact_id`, `contact_name`, `contact_phone` , `payment_option` ,	`check_status_phone` ,	`total` ,	`total_discount` ,	`total_pdv` ,	`total_items` ,	`hide_rebate` ,	`further_sale`,	`note1` ,	`note2` ,	`note3` ,	`created_date` ,	`created_by` ,	`updated_date` ,	`updated_by`) VALUES
(3, 'POR12-00003','POR12-00003', 1,2, '2010-10-12 10:20:20', '300', 'SA1', 1, 'ext doc', 'quote no', 0,0,0,0,'used limitation', 2,2,2, '2012-12-12 20:20:20', null, 1, 3, null,2,'contact name','06457575',0, 'startus phone', 1000, 1000, 5, 200, 0,0, 'note1', 'note2', 'note3', '2012-12-12 20:20:20','sys', '2012-12-12 20:20:20', 'sys');
INSERT INTO `sale_orders` (	`_id`, `sales_order_device_no`,	`sales_order_no` ,	`document_type` ,	`customer_id` ,	`order_date` ,	`location_code` ,	`shortcut_dimension_1_code` ,	`currency_code` ,	`external_document_no` ,	`quote_no` ,	`backorder_shipment_status` ,	`order_status_for_shipment` ,	`fin_control_status` ,`order_condition_status` ,	`used_credit_limit_by_employee` ,	`order_value_status` ,	`quote_realized_status` ,	`special_quote` ,	`quote_valid_date_to` ,	`cust_uses_transit_cust` ,	`sales_person_id` ,	`sell_to_address_id`, `shipp_to_address_id`, `contact_id`, `contact_name`, `contact_phone` , `payment_option` ,	`check_status_phone` ,	`total` ,	`total_discount` ,	`total_pdv` ,	`total_items` ,	`hide_rebate` ,	`further_sale`,	`note1` ,	`note2` ,	`note3` ,	`created_date` ,	`created_by` ,	`updated_date` ,	`updated_by`) VALUES
(4, 'POR12-00004','POR12-00004', 1,1, '2012-12-12 00:20:20', '300', 'SA2', 1, 'ext doc', 'quote no', 0,0,0,0,'used limitation', 2,2,2, '2012-12-12 20:20:20', null, 1, 1, null,1,'contact name','06457575',1, 'startus phone', 22000, 1000, 5, 200, 0,0, 'note1', 'note2', 'note3', '2012-12-12 20:20:20','sys', '2012-12-12 20:20:20', 'sys');
INSERT INTO `sale_orders` (	`_id`, `sales_order_device_no`,	`sales_order_no` ,	`document_type` ,	`customer_id` ,	`order_date` ,	`location_code` ,	`shortcut_dimension_1_code` ,	`currency_code` ,	`external_document_no` ,	`quote_no` ,	`backorder_shipment_status` ,	`order_status_for_shipment` ,	`fin_control_status` ,`order_condition_status` ,	`used_credit_limit_by_employee` ,	`order_value_status` ,	`quote_realized_status` ,	`special_quote` ,	`quote_valid_date_to` ,	`cust_uses_transit_cust` ,	`sales_person_id` ,	`sell_to_address_id`, `shipp_to_address_id`, `contact_id`, `contact_name`, `contact_phone` , `payment_option` ,	`check_status_phone` ,	`total` ,	`total_discount` ,	`total_pdv` ,	`total_items` ,	`hide_rebate` ,	`further_sale`,	`note1` ,	`note2` ,	`note3` ,	`created_date` ,	`created_by` ,	`updated_date` ,	`updated_by`) VALUES
(5, null,'POR12-00005', 1,1, '2010-12-12 08:20:20', '300', 'SA2', 0, 'ext doc', 'quote no', 0,0,0,0,'used limitation', 2,2,2, '2012-12-12 20:20:20', null, 1, 1, null,1,'contact name','06457575',1, 'startus phone', 8000, 1000, 5, 200, 0,0, 'note1', 'note2', 'note3', '2012-12-12 20:20:20','sys', '2012-12-12 20:20:20', 'sys');
INSERT INTO `sale_orders` (	`_id`, `sales_order_device_no`,	`sales_order_no` ,	`document_type` ,	`customer_id` ,	`order_date` ,	`location_code` ,	`shortcut_dimension_1_code` ,	`currency_code` ,	`external_document_no` ,	`quote_no` ,	`backorder_shipment_status` ,	`order_status_for_shipment` ,	`fin_control_status` ,`order_condition_status` ,	`used_credit_limit_by_employee` ,	`order_value_status` ,	`quote_realized_status` ,	`special_quote` ,	`quote_valid_date_to` ,	`cust_uses_transit_cust` ,	`sales_person_id` ,	`sell_to_address_id`, `shipp_to_address_id`, `contact_id`, `contact_name`, `contact_phone` , `payment_option` ,	`check_status_phone` ,	`total` ,	`total_discount` ,	`total_pdv` ,	`total_items` ,	`hide_rebate` ,	`further_sale`,	`note1` ,	`note2` ,	`note3` ,	`created_date` ,	`created_by` ,	`updated_date` ,	`updated_by`) VALUES
(6, 'POR12-00006',null, 1,1, '2011-12-12 09:20:20', '300', 'SA2', 0, 'ext doc', 'quote no', 0,0,0,0,'used limitation', 2,2,2, '2012-12-12 20:20:20', null, 1, 1, null,1,'contact name','06457575',1, 'startus phone', 6000, 1000, 5, 200, 0,0, 'note1', 'note2', 'note3', '2012-12-12 20:20:20','sys', '2012-12-12 20:20:20', 'sys');
